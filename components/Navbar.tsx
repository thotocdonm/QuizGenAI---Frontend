...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 glass-morphism shadow-sm bg-white dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-800">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {user ? (
              <div className="relative">
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-950 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 py-2 z-50 animate-in fade-in zoom-in-95 duration-200">
                    <Link
                      to="/manage"
            ...
            <div className="w-full max-w-sm rounded-2xl bg-white dark:bg-gray-900 dark:bg-gray-900 dark:bg-gray-900 p-6 shadow-2xl border border-gray-100 dark:border-gray-800">
              ...
              <div className="mt-6 flex items-center justify-end gap-3">
                <button
                  ...
                  className="px-4 py-2 rounded-xl border-2 border-gray-200 bg-white dark:bg-gray-900 dark:bg-gray-900 font-bold text-gray-700 dark:text-gray-300 hover:border-gray-400 transition-all"
                >
                  Hủy
                </button>
                <button
